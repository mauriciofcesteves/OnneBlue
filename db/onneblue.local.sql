...
-- Copiando dados para a tabela erp.acos: ~168 rows (aproximadamente)
DELETE FROM `acos`;
/*!40000 ALTER TABLE `acos` DISABLE KEYS */;
INSERT INTO `acos` (`id`, `parent_id`, `model`, `foreign_key`, `alias`, `lft`, `rght`, `show`, `order`, `name`, `description`) VALUES
	(1, NULL, NULL, NULL, 'controllers', 1, 500, 0, 0, NULL, NULL),
	...
	(296, 1, NULL, NULL, 'FinancialSystem', 454, 485, 0, 0, NULL, NULL),
	(297, 296, NULL, NULL, 'Dashboard', 455, 458, 0, 0, NULL, NULL),
	(298, 297, NULL, NULL, 'admin_index', 456, 457, 0, 0, NULL, NULL),
	(299, 296, NULL, NULL, 'AccountsPayable', 459, 470, 0, 0, NULL, NULL),
	(300, 299, NULL, NULL, 'admin_index', 460, 461, 0, 0, NULL, NULL),
	(301, 299, NULL, NULL, 'admin_view', 462, 463, 0, 0, NULL, NULL),
	(302, 299, NULL, NULL, 'admin_add', 464, 465, 0, 0, NULL, NULL),
	(303, 299, NULL, NULL, 'admin_edit', 466, 467, 0, 0, NULL, NULL),
	(304, 299, NULL, NULL, 'admin_delete', 468, 469, 0, 0, NULL, NULL),
	(305, 296, NULL, NULL, 'BanksAccounts', 471, 482, 0, 0, NULL, NULL),
	(306, 305, NULL, NULL, 'admin_index', 472, 473, 0, 0, NULL, NULL),
	(307, 305, NULL, NULL, 'admin_view', 474, 475, 0, 0, NULL, NULL),
	(308, 305, NULL, NULL, 'admin_add', 476, 477, 0, 0, NULL, NULL),
	(309, 305, NULL, NULL, 'admin_edit', 478, 479, 0, 0, NULL, NULL),
	(310, 305, NULL, NULL, 'admin_delete', 480, 481, 0, 0, NULL, NULL),
	(311, 296, NULL, NULL, 'BanksLists', 483, 484, 0, 0, NULL, NULL),
	(312, 113, NULL, NULL, 'Dashboard', 375, 380, 0, 0, NULL, NULL),
	(313, 312, NULL, NULL, 'admin_index', 376, 377, 0, 0, NULL, NULL),
	(314, 312, NULL, NULL, 'admin_aco_sync', 378, 379, 0, 0, NULL, NULL),
	(315, 1, NULL, NULL, 'Notifications', 486, 495, 0, 0, NULL, NULL),
	(316, 315, NULL, NULL, 'admin_index', 487, 488, 0, 0, NULL, NULL),
	(317, 315, NULL, NULL, 'check', 489, 490, 0, 0, NULL, NULL),
	(318, 315, NULL, NULL, 'inputsNearExpirationDate', 491, 492, 0, 0, NULL, NULL),
	(319, 315, NULL, NULL, 'admin_view', 493, 494, 0, 0, NULL, NULL),
	(320, 1, NULL, NULL, 'Businesses', 496, 499, 0, 0, NULL, NULL),
	(322, 320, NULL, NULL, 'admin_removeNotificationAlert', 497, 498, 0, 0, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `businesses` (
  ...
  `has_notification` tinyint(3) unsigned DEFAULT '0',
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
...
INSERT INTO `businesses` (`id`, `plan_id`, `additional_users`, `name`, `status`, `tour`, `has_notification`, `created`, `modified`) VALUES
	(1, 3, 0, 'Harvest Sistemas', 'Active', 0, 0, '2014-09-23 04:33:15', '2015-02-10 23:21:07'),
	(2, 1, 0, NULL, '', 0, 0, '2014-10-23 00:00:09', '2014-10-23 00:00:09'),
	(3, 2, 0, NULL, '', 0, 0, '2014-10-23 00:06:45', '2014-10-23 00:06:45'),
	(4, 3, 0, NULL, '', 0, 0, '2014-11-19 17:38:55', '2014-11-19 17:38:55');
...
-- Copiando estrutura para tabela erp.is_categories
CREATE TABLE IF NOT EXISTS `is_categories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Copiando dados para a tabela erp.is_categories: ~3 rows (aproximadamente)
DELETE FROM `is_categories`;
/*!40000 ALTER TABLE `is_categories` DISABLE KEYS */;
INSERT INTO `is_categories` (`id`, `business_id`, `name`, `created`, `modified`) VALUES
...
/*!40000 ALTER TABLE `is_categories` ENABLE KEYS */;


-- Copiando estrutura para tabela erp.is_categories_products
CREATE TABLE IF NOT EXISTS `is_categories_products` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Copiando dados para a tabela erp.is_categories_products: ~0 rows (aproximadamente)
DELETE FROM `is_categories_products`;
/*!40000 ALTER TABLE `is_categories_products` DISABLE KEYS */;
INSERT INTO `is_categories_products` (`id`, `category_id`, `product_id`) VALUES
	(4, 4, 6);
/*!40000 ALTER TABLE `is_categories_products` ENABLE KEYS */;


-- Copiando estrutura para tabela erp.is_customers
...
-- Copiando dados para a tabela erp.is_customers: ~5 rows (aproximadamente)
DELETE FROM `is_customers`;
/*!40000 ALTER TABLE `is_customers` DISABLE KEYS */;
INSERT INTO `is_customers` (`id`, `business_id`, `name`, `email`, `is_cnpj`, `cnpj_cpf`, `phone_number`, `phone_number2`, `address`, `site`, `birthday`, `created`, `modified`) VALUES
...
/*!40000 ALTER TABLE `is_customers` ENABLE KEYS */;


-- Copiando estrutura para tabela erp.is_inputs_outputs
CREATE TABLE IF NOT EXISTS `is_inputs_outputs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `business_id` int(10) unsigned NOT NULL,
...
-- Copiando dados para a tabela erp.is_inputs_outputs: ~8 rows (aproximadamente)
DELETE FROM `is_inputs_outputs`;
/*!40000 ALTER TABLE `is_inputs_outputs` DISABLE KEYS */;
INSERT INTO `is_inputs_outputs` (`id`, `business_id`, `user_id`, `product_id`, `supplier_id`, `customer_id`, `movimentation_date`, `new_value`, `is_input`, `quantity`, `observation`, `adjustment_date`, `expiration_date`, `created`, `modified`) VALUES
	...
	(7, 1, 1, 8, 2, NULL, '2015-02-06 00:00:00', 2, 1, 10, '', NULL, '2015-02-16 00:00:00', '2015-02-06 12:55:51', '2015-02-06 12:55:51'),
	(8, 1, 1, 8, 2, NULL, '2015-02-06 00:00:00', 2, 1, 8, '', NULL, '2015-02-20 00:00:00', '2015-02-06 20:36:25', '2015-02-06 20:36:25'),
	(9, 1, 1, 5, 1, NULL, '2015-02-06 00:00:00', 0, 1, 73, '', NULL, NULL, '2015-02-06 21:26:06', '2015-02-06 21:26:06'),
	(10, 1, 1, 8, 1, NULL, '2015-02-06 00:00:00', 2, 1, 10, '', NULL, '2015-02-18 00:00:00', '2015-02-06 21:26:06', '2015-02-06 21:26:06');
/*!40000 ALTER TABLE `is_inputs_outputs` ENABLE KEYS */;


-- Copiando estrutura para tabela erp.is_products
...
-- Copiando dados para a tabela erp.is_products: ~6 rows (aproximadamente)
DELETE FROM `is_products`;
/*!40000 ALTER TABLE `is_products` DISABLE KEYS */;
INSERT INTO `is_products` (`id`, `business_id`, `units_measure_id`, `code`, `name`, `description`, `purchase_value`, `sell_value`, `minimum_quantity`, `notify_low_stock`, `created`, `modified`) VALUES
	...
	(8, 1, 0, '123', 'Suco', '', 2.00, 4.00, 0, NULL, '2015-02-06 12:52:55', '2015-02-06 12:52:55');
/*!40000 ALTER TABLE `is_products` ENABLE KEYS */;


-- Copiando estrutura para tabela erp.is_suppliers
CREATE TABLE IF NOT EXISTS `is_suppliers` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `business_id` int(10) unsigned NOT NULL,
  `name` varchar(50) NOT NULL,
...
-- Copiando dados para a tabela erp.is_suppliers: ~3 rows (aproximadamente)
DELETE FROM `is_suppliers`;
/*!40000 ALTER TABLE `is_suppliers` DISABLE KEYS */;
INSERT INTO `is_suppliers` (`id`, `business_id`, `name`, `email`, `is_cnpj`, `cnpj_cpf`, `phone_number`, `phone_number2`, `address`, `site`, `created`, `modified`) VALUES
...
-- Copiando estrutura para tabela erp.is_units_measures
CREATE TABLE IF NOT EXISTS `is_units_measures` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `business_id` int(10) unsigned NOT NULL,
  `name` varchar(30) NOT NULL,
...
-- Copiando dados para a tabela erp.is_units_measures: ~4 rows (aproximadamente)
DELETE FROM `is_units_measures`;
/*!40000 ALTER TABLE `is_units_measures` DISABLE KEYS */;
INSERT INTO `is_units_measures` (`id`, `business_id`, `name`, `abbreviation`, `created`, `modified`) VALUES
...
/*!40000 ALTER TABLE `is_units_measures` ENABLE KEYS */;
...
INSERT INTO `modules` (`id`, `name`, `description`, `plugin`, `status`, `created`, `modified`) VALUES
	...
	(2, 'Financial System', '', 'FinancialSystem', 'Active', '2014-09-23 09:42:38', '2014-09-23 09:42:38');
...
-- Copiando estrutura para tabela erp.notifications
CREATE TABLE IF NOT EXISTS `notifications` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `entity_id` int(10) unsigned NOT NULL,
  `business_id` int(10) unsigned NOT NULL,
  `module_id` int(10) unsigned NOT NULL,
  `type` enum('Input expiration') NOT NULL,
...
-- Copiando dados para a tabela erp.notifications: ~2 rows (aproximadamente)
DELETE FROM `notifications`;
/*!40000 ALTER TABLE `notifications` DISABLE KEYS */;
INSERT INTO `notifications` (`id`, `entity_id`, `business_id`, `module_id`, `type`, `is_read`, `created`, `modified`) VALUES
	(1, 7, 1, 1, 'Input expiration', 1, '2015-02-06 20:42:00', '2015-02-10 23:24:57'),
	(4, 8, 1, 1, 'Input expiration', 1, '2015-02-06 20:58:21', '2015-02-06 20:58:21'),
	(5, 8, 1, 1, 'Input expiration', 1, '2015-01-06 20:58:21', '2015-01-06 20:58:21');
