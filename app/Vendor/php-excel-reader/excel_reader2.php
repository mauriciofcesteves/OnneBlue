			...
			switch ($code) {
				case SPREADSHEET_EXCEL_READER_TYPE_SST:
					...
					for ($i = 0; $i < $uniqueStrings; $i++) {
						...
						//@MFCEF ANTIGO para conseguir imprimir palavras com acentuação(Mudei)
						//http://stackoverflow.com/questions/9425167/spreadsheet-excel-reader-phpexcelreader-fails-on-accent-encoding
	...
	function _encodeUTF16($string) {
		...
		if ($this->_defaultEncoding){
			switch ($this->_encoderFunction){
				//@MFCEF falha nos hiperlinks da planilha, linha antiga modificada para essa nova
				//fonte: http://www.yiiframework.com/forum/index.php/topic/21059-import-data-from-excel-sheet/
